...
# 共轭梯度法变种之 Fletcher Reeves 方法
def fr_method(a, b, init_point, interval, eps):
	...
	while math.fabs(now-pre) > eps:
		...
		# β 系数
		beta = (g_y[0]*g_y[0]+g_y[1]*g_y[1]) / (g_z[0]*g_z[0]+g_z[1]*g_z[1])
...
if __name__ == '__main__':
	...
	print(fr_method(1, 100, [10,10], [0,0.005], 0.000001))